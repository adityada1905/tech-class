...
export const fetchCourseCategories = async () => {
  ...
  try {
      ...
      result = response.data.data.categories; // Now this will work with the updated backend
...
export const createSection = async (data, token) => {
  ...
  try {
    ...
    result = response?.data?.updatedCourse; // Ensure this returns the entire course data with the new section included
  } catch (error) {
